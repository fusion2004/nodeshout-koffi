...
export const shout_set_host = lib.func("int shout_set_host(shout_t *self, str host)") as KoffiFunc<
  (self: ShoutPtr, host: string) => ShoutErrorType
>;
...
) as KoffiFunc<(self: ShoutPtr, port: number) => ShoutErrorType>;
...
export const shout_set_user = lib.func("int shout_set_user(shout_t *self, str user)") as KoffiFunc<
  (self: ShoutPtr, user: string) => ShoutErrorType
>;
...
) as KoffiFunc<(self: ShoutPtr, password: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, mount: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, agent: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, file: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, ciphers: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, certificate: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, name: string, value: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, key: string, value: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, isPublic: number) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, contentLanguage: string | null) => ShoutErrorType>;
...
export const shout_set_content_format = lib.func(
  ...
  (self: ShoutPtr, format: ShoutFormat, usage: number, codecs: string | null) => ShoutErrorType
>;
...
) as KoffiFunc<(self: ShoutPtr, data: Buffer | Uint8Array, len: number) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, metadata: ShoutMetadataPtr) => ShoutErrorType>;
...
) as KoffiFunc<(metadata: ShoutMetadataPtr, key: string, value: string) => ShoutErrorType>;
...
export const shout_set_name = lib.func("int shout_set_name(shout_t *self, str name)") as KoffiFunc<
  (self: ShoutPtr, name: string) => ShoutErrorType
>;
...
export const shout_set_url = lib.func("int shout_set_url(shout_t *self, str url)") as KoffiFunc<
  (self: ShoutPtr, url: string) => ShoutErrorType
>;
...
) as KoffiFunc<(self: ShoutPtr, genre: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, description: string) => ShoutErrorType>;
...
) as KoffiFunc<(self: ShoutPtr, dumpfile: string) => ShoutErrorType>;
